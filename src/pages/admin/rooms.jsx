...
import { Button, Container, Row, Col, Card, Spinner, Alert, Badge } from "react-bootstrap";
import ToastMessage from "../../components/ToastMessage";
import CreateRoomForm from "../../components/CreateRoomForm";
import "bootstrap/dist/css/bootstrap.min.css";
import { Link } from "react-router-dom";
import { BsArrowLeft, BsPlusCircle, BsPencil, BsTrash, BsDoorOpen, BsPeople, BsBuilding } from 'react-icons/bs';
    ...
    return (
        <Container fluid className="py-4 px-4" style={{ backgroundColor: "#212529", minHeight: "100vh" }}>
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <Link to="/admin" className="btn btn-outline-light d-inline-flex align-items-center mb-3">
                ...
                <Alert variant="info">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p className="mb-0">No rooms available. Create your first room to get started.</p>
                        </div>
                    </div>
                </Alert>
            )}
                            ...
                            >
                                <Card.Body className="d-flex flex-column text-white">
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                        <Badge bg="primary" pill className="px-3 py-2 fs-6">{room.building.name}</Badge>
