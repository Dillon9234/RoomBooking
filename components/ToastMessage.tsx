...
export default function ToastMessage({ text, type, onClose }: { text: string; type: "success" | "error"; onClose: () => void }) {
    ...
    return (
        <div className={`fixed bottom-2 right-0 flex items-center gap-3 px-5 py-3 rounded-l-lg shadow-lg z-50
            ...
            <button onClick={() => { setFadeOut(true); onClose(); }} className={`ml-auto transition
